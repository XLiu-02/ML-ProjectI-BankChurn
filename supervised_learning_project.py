...
Original file is located at
    https://colab.research.google.com/drive/1s3u2CB1T91gCpr4-isIrkABuNPGsGGRZ

# Bank Customer Churn Prediction

In this project, we use supervised learning models to identify customers who are likely to churn in the future. Furthermore, we will analyze top factors that influence user retention. [Dataset information](https://www.kaggle.com/adammaus/predicting-churn-for-bank-customers). (bank_churn.csv)
...
#https://drive.google.com/file/d/1wJ0xOQCMHXF8RNtpNFwsP_HN8jnqGjOl/view?usp=sharing
id = "1wJ0xOQCMHXF8RNtpNFwsP_HN8jnqGjOl"
